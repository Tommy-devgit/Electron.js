...
function App() {
  ...
  useEffect(() => {
    if (!electronApi?.subscribeChangeView) {
      return;
    }
    return electronApi.subscribeChangeView((view) => setActiveView(view))
  }, [electronApi])
...
function SelectOption(props: {
  ...
  return <button className='selectOption' onClick={props.onClick}>
